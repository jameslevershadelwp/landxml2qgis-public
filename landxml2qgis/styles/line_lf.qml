...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="@horizDistanceFeet"/>
    <field editable="1" name="@horizDistanceLinks"/>
