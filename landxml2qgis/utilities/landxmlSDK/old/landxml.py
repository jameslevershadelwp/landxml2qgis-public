...
class CgPoints(GeneratedsSuper):
    ...
    def get_CgPoint(self, name):
        return self.CgPoint.get(name)

    def set_CgPoint(self, CgPoint):
        self.CgPoint = CgPoint

    def add_CgPoint(self, value):
        self.CgPoint[value.name] = value
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
        ...
        if pretty_print:
            ...
            eol_ = ''
        for CgPoint_ in self.CgPoint.values():
...
class ObservationGroup(GeneratedsSuper):
    ...
    def get_ReducedArcObservations(self):
        return self.ReducedArcObservation

    def get_ReducedArcObservation(self, setup, target):
        return self.ReducedArcObservation.get((setup, target))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
        ...
        if pretty_print:
            ...
            eol_ = ''
        for ReducedObservation_ in self.ReducedObservation.values():
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'ReducedObservation':
            ...
            obj_.build(child_, gds_collector_=gds_collector_)
            self.ReducedObservation[(obj_.setupID, obj_.targetSetupID)] = obj_
            ...
            obj_.build(child_, gds_collector_=gds_collector_)
            self.ReducedArcObservation[(obj_.setupID, obj_.targetSetupID)] = obj_
